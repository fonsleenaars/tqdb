...
def test_character_template_variables():
    ...
    template = templates_by_path[
        base.ParametersCharacterParser.get_template_path()]

    # Iterate over the variables for this parser:
    missing = [
        variable
        for variable in template.variables.keys()
        if not is_covered_variable(variable)]
...
def test_defensive_template_variables():
    ...
    def is_covered_variable(field):
        ...
        return is_suffixed(
            ['Modifier', 'ModifierChance', 'Chance'],
            field,
            base.ParametersDefensiveParser.FIELDS
        )

    # Grab the template to check variables for
    template = templates_by_path[
        base.ParametersDefensiveParser.get_template_path()]
...
def test_augment_template_variables():
    ...
    # Grab the template to check variables for
    template = templates_by_path[
        base.ItemSkillAugmentParser.get_template_path()]
...
def test_offensive_template_variables():
    ...
    # Grab the template to check variables for
    template = templates_by_path[
        base.ParametersOffensiveParser.get_template_path()]
...
def test_skill_template_variables():
    ...
    def is_covered_variable(field):
        ...
        return is_suffixed(
            ['Modifier', 'ModifierChance', 'Chance'],
            field,
            base.ParametersSkillParser.FIELDS
        )

    # Grab the template to check variables for
    template = templates_by_path[
        base.ParametersSkillParser.get_template_path()]
